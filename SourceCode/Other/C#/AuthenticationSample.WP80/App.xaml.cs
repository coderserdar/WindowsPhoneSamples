...
namespace AuthenticationSample.WP80
{
    public partial class App
    {
        ...
        public App()
        {
            ...
            _logManager = SimpleIoc.Default.GetInstance<ILogManager>();
            _logManager.Init(Current, RootFrame, string.Empty);
        ...
        /// <summary>
        /// Handles the Navigating event of the RootFrame control.
        /// </summary>
        ...
        private async void RootFrame_Navigating(object sender, NavigatingCancelEventArgs e)
        {
            ...
            try
            {
                ...
                var loginToken = settings.Any(o => o.Key == Constants.LoginToken);
                ...
                if (!loginToken)
                {
                    ...
                    RootFrame.Dispatcher.BeginInvoke(
                        () => RootFrame.Navigate(new Uri(Constants.LoginView, UriKind.Relative)));
                }
